...
async def start_Destroyer():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if eleventh:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if twelvth:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if thirtenth:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if forteenth :
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if fifteenth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if sixteenth:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seventeenth:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eighteenth:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ninteenth:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if twenty:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            bc = Destroyer[0]
            text = "ᖇᗴᗷᗴᒪ IS ON WAY........"
            event = await e.reply(text, parse_mode=None, link_preview=None )
            try:
                await e.client(functions.channels.JoinChannelRequest(channel=bc))
                await event.edit("ᖇᗴᗷᗴᒪ JOINED....")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"🔰ᒍIᑎᗪᗩ ᕼᑌᑌ ᗷᕼOՏᗪKK🔰")
...
async def restart(e):
    if e.sender_id in SMEX_USERS:
        text = "𝙍𝙚𝙨𝙩𝙖𝙧𝙩𝙚𝙙\n\nPlease wait till ᖇᗴᗷᗴᒪ came online again....."
        await e.reply(text, parse_mode=None, link_preview=None )
        try:
...
print(text)
print("")
print("SMEXYYY!!! ᖇᗴᗷᗴᒪ SPAM BOT STARTED SUCCESFULLY, JAO GAAND FAAD DO SPAM ME.")
